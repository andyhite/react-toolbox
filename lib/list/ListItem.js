  ...
  var ListItem = function (_Component) {
    ...
    _createClass(ListItem, [{
      ...
      value: function render() {
        ...
        var other = _objectWithoutProperties(_props, ['className', 'onMouseDown', 'onTouchTap', 'to', 'onClick', 'ripple', 'theme']); //eslint-disable-line no-unused-vars
        ...
        return _react2.default.createElement(
          'li',
          { className: theme.listItem + ' ' + className, onClick: this.handleClick, onMouseDown: onMouseDown, onTouchTap: onTouchTap },
